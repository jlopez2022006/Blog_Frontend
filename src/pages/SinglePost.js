...
const SinglePost = () => {
    ...
    return (
        <>
            <Navbar />
            <Box sx={{ backgroundImage: "url('https://images.pexels.com/photos/4792352/pexels-photo-4792352.jpeg?cs=srgb&dl=pexels-anete-lusina-4792352.jpg&fm=jpg')", display: 'flex', justifyContent: 'center', pt: 4, pb: 4, minHeight: "100vh" }}>
                {
                    loading ? <Loader /> :
                        <>
                            <Card sx={{ maxWidth: 1000, mx: 'auto', width: '90%' }}>
                                <CardHeader
                                    avatar={
                                        ...
                                        userInfo ?
                                            <>
                                                <Box sx={{ pt: 1, pl: 3, pb: 3, bgcolor: "#fafafa" }}>
                                                    <h2>Agrega tu comentario aqui!</h2>
                                            ...
                                            : <>
                                                <Link to='/login'> Para comentar debes iniciar sesion</Link>
                                            </>
                                    }
